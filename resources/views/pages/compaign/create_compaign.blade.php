                        ...
                        <div id="multi-step-form" class="row justify-content-center">
                            <div class="col-md-10">
                                <div class="step step-1">
                                    <section>
                                        <form action="{{ route('store.step1.compaign') }}" id="form_step_1" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex justify-content-end mt-2">
                                            <button type="button" data-form="form_step_1" class="btn px-5 btn-primary next-step fw-bold">Next</button>
                                        </div>
                                    </section>
                                </div>
                                ...
                                <div class="step step-2">
                                    ...
                                    <div class="d-flex justify-content-end mt-2  ">
                                        ...
                                        <button data-form="form_step_2" type="button" class="btn px-5 btn-primary next-step mx-1 ">Next</button>
                                    </div>
                                </div>
        ...
        function ImgUpload() {
            ...
            $('body').on('submit', '#product_detail_from', function(e) {
                ...
                $('.variant-image-exist').each(function(index, element) {
                    var variantId = $(element).closest('.row').find('input[name="variant_id[]"]').val();
