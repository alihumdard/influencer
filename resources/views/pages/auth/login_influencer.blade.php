                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
                        ...
                        <div class="d-flex align-items-center justify-content-center" style="height: calc(100vh - 80px);">
                            <img src="/assets/images/backgrounds/Photo-bro.png" alt="" class="img-fluid" width="100%" style="max-width: 500px;">
                        </div>
                    </div>
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
                                    ...
                                    <div class="col-12 mb-3">
                                        <form>
                                            <div class="col-12 mb- mb-sm-0">
                                                <a class="btn btn-lg btn-light text-dark border fw-normal d-flex align-items-center justify-content-center rounded-2 py-2" href="{{ route('login.influencer') }}" role="button">
