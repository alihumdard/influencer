                    ...
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
                        <div class="card mb-0 shadow-none rounded-0 min-vh-100 h-100 text-white" style="background-color: rgb(178, 1, 99)">
                            <div class="d-flex align-items-center w-100 h-100">
                                <div class="card-body">
                                    <div class="mb-5">
                                        <h2 class="fw-bolder fs-7 mb-1 text-white">How to Verify whatsapp </h2>
                                        <p class="mb-0">
                                            Copy the code and send it to our whatsapp provide paste code the inbox. Ensure you send it from the connected whatsapp account for a seamless experience.
                                        </p>
                                    </div>
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="d-flex mt-2 justify-content-center pb-1">
                                                    <a href="https://api.whatsapp.com/send?phone=92340602398&text=why otp is that {{$otp}}. Please verify my whatsapp account" target="_blank" id="verifyButton" class="btn btn-lg px-4 bg-white">
                                                    ...
                                                    <a href="{{ route('wt.vefied.store') }}" id="nextButton" class="btn btn-lg text-light px-4 bg-dark ms-3 disabled-link">
