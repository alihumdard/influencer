                    ...
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
                        <div class="card mb-0 shadow-none rounded-0 min-vh-100 h-100 text-white" style="background-color: rgb(178, 1, 99)">
                            <div class="d-flex align-items-center w-100 h-100">
                                <div class="card-body">
                                    <div class="mb-5">
                                        <h2 class="fw-bolder fs-7 mb-3 text-white">Add Your whatsapp</h2>
                                        <p class="mb-0">
                                            Please enter the whatsapp number associated with your account.
                                        </p>

                                    </div>
                                    <div class="col-12">
                                        <form action="{{ route('store.verify.whatsapp') }}" method="post">
                                            @csrf
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputPhone" class="form-label text-white">Whatsapp Number</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" name="whatsapp" class="form-control custom-input" id="exampleInputPhone" placeholder="Enter your whatsapp number" aria-describedby="phoneHelp" required pattern="[0-9]{10}" maxlength="10">
                                                </div>
