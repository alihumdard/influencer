                    ...
                    <div class="col-lg-6 col-xl-6 col-xxl-6">
                        <div class="card mb-0 shadow-none rounded-0 min-vh-100 h-100 text-white" style="background-color: rgb(178, 1, 99)">
                            <div class="d-flex align-items-center w-100 h-100">
                                <div class="card-body">
                                    <div class="mb-5">
                                        <h2 class="fw-bolder fs-7 mb-1 text-white">How to Verify Youtube chanel?</h2>
                                        <p class="mb-0">
                                            Copy the code and send it to our video provide link in comment paste the screen shot. Ensure you send it from the connected Instagram account for a seamless experience.
                                        </p>
                                    </div>
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="d-flex  mt-2 justify-content-center pb-1">
                                                    <a href="https://www.youtube.com/watch?v=vMZvwJR3sSk" target="_blank" id="verifyButton" class="btn btn-lg px-4 bg-white">
                                                        <b class="text-dark">Comment</b>
                                                        <img src="/assets/images/icons/iv_share.png" alt="Send Icon" style="height: 25px; width: 25px; margin-left: 8px;">
                                                    </a>
                                                    <a href="{{ route('socail.yt.details') }}" id="nextButton" class="btn btn-lg text-light px-4 bg-dark ms-3 disabled-link">
