...
@section('content')
    <style>
        ...
        .chat-application {
            ...
            border: 1px solid #91225f;
        }

        .border-bottom {
            border-bottom: 1px solid #91225f !important;
        }

        .border-top{
            border-top: 1px solid #91225f !important;
        }

        .user-chat-box {
            border: 1px solid #91225f !important;
        }
        ...
        .simplebar-content a{
            border-bottom: 1px solid #91225f;
        }
    </style>
                ...
                <div class="card">
                    <div class="card-body ">
                        <div class="card overflow-hidden chat-application">
                            ...
                            <div class="d-flex">
                                <div class="w-30 d-none d-lg-block user-chat-box">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item d-flex align-items-center gap-2"
                                                            href="javascript:void(0)"><span><i
                                                                    class="ti ti-help fs-4"></i></span>Help and
                                                            feadback</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item d-flex align-items-center gap-2"
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item d-flex align-items-center gap-2"
                                                            href="javascript:void(0)"><span><i
                                                                    class="ti ti-login fs-4"></i></span>Sign Out</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                                    ...
                                                                    ">
                                                                        ...
                                                                        <div class="offcanvas-body p-9">
                                                                            <div class="media-chat mb-7">
                                                                                <div class="row">
                                                                                    <div class="col-4 px-1">
                                                                                        <div
                                                                                            class="rounded-1 overflow-hidden mb-2">
                                                                                            <img src="../assets/images/products/product-1.jpg"
                                                                                                alt=""
                                                                                                class="w-100" />
                                                                                        </div>
                                                                            ...
                                                                            <div class="files-chat">
                                                                                ...
                                                                                <a href="javascript:void(0)"
                                                                                    class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                                                                                    <div
                                                                                ...
                                                                                <a href="javascript:void(0)"
                                                                                    class="hstack gap-3 file-chat-hover justify-content-between">
                                                                                    <div
                                                                                        class="d-flex align-items-center gap-3">
                                                                                        <div
                                                                                            class="rounded-1 text-bg-light p-6">
                                ...
                                <div class="offcanvas offcanvas-start user-chat-box chat-offcanvas" tabindex="-1"
                                    ...
                                    <div class="px-4 pt-9 pb-6">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <a class="dropdown-item border-bottom" href="javascript:void(0)">Sort
                                                        by Unread</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0)">Hide favourites</a>
                                    ...
                                    <div class="app-chat">
                                        <ul class="chat-users" style="height: calc(100vh - 200px)" data-simplebar>
                                            <li>
                                                <a href="javascript:void(0)"
                                                    class="px-4 py-3 d-flex align-items-start justify-content-between chat-user"
                                                    id="chat_user_1" data-user-id="1">
                                                    <div class="d-flex align-items-center">
                                                        <span class="position-relative">
                                                            <img src="../assets/images/profile/user-1.jpg" alt="user1"
